...
export type AllSanitySchemaTypes = Order | Subcategory | Category | ProductType | BlockContent | SanityImagePaletteSwatch | SanityImagePalette | SanityImageDimensions | SanityImageHotspot | SanityImageCrop | SanityFileAsset | SanityImageAsset | SanityImageMetadata | Geopoint | Slug | SanityAssetSourceData;
...
// Query: *[_type == "productType" && slug.current == $slug][0]{    ...,    categories[]->{      _id,      name,    }  }
